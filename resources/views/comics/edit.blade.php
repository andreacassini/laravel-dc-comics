                    ...
                    <div class="form-group border p-3">
                        <div class="row">
                            ...
                            <div class="col-12 my-3">
                                ...
                                <textarea name="description" id="description" placeholder="Inserisci la descrizione" class="form-control" required>{{ old('description') ?? $comic->description }}</textarea>
                            </div>
                            <div class="col-12 my-3">
                            ...
                            <div class="col-12 my-3">
                                ...
                                <textarea name="artists" id="artists" placeholder="Inserisci gli artisti" class="form-control" required>{{ old('artists') ?? $comic->artists }}</textarea>
                            </div>
                            <div class="col-12 my-3">
                                <label class="control-label my-3">Scrittori</label>
                                <textarea name="writers" id="writers" placeholder="Inserisci gli scrittori" class="form-control" required>{{ old('writers') ?? $comic->writers }}</textarea>
                            </div>
